...
//   }
  ...
  hostedEvents = () => {
    return this.context.userHostedEvents.map(event => {
      return(
        ...
        Requesting to Book Event: {event.requestors ? <RequestorsList eventId ={event.id} slots_available={event.slots_available} requestors={event.requestors}/> : 'none'}
        <ul>
